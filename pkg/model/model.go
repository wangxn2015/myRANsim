...
type Model struct {
	MapLayout               MapLayout               `json:"layout" yaml:"layout"`
	RouteEndPoints          []RouteEndPoint         `json:"routeEndPoints" yaml:"routeEndPoints"`
	WayPointRoute           bool                    `json:"wayPointRoute" yaml:"wayPointRoute"`
	DirectRoute             bool                    `json:"directRoute" yaml:"directRoute"`
	Nodes                   map[string]Node         `json:"nodes" yaml:"nodes"`
	Cells                   map[string]Cell         `json:"cells" yaml:"cells"`
	Controllers             map[string]Controller   `json:"controllers" yaml:"controllers"`
	LocalConfigs            map[string]LocalConfig  `yaml:"localConfigs"`
	ServiceModels           map[string]ServiceModel `json:"servicemodels" yaml:"servicemodels"`
	RrcStateChangesDisabled bool                    `json:"RrcStateChangesDisabled" yaml:"RrcStateChangesDisabled"`
	InitialRrcState         string                  `json:"initialRrcState" yaml:"initialRrcState"`
	UECount                 uint                    `json:"ueCount" yaml:"ueCount"`
	UECountPerCell          uint                    `json:"ueCountPerCell" yaml:"ueCountPerCell"`
	Plmn                    string                  `json:"plmnID" yaml:"plmnID"`
	PlmnID                  types.PlmnID            `json:"plmnNumber" yaml:"plmnNumber"` // overridden and derived post-load from "Plmn" field
	APIKey                  string                  `json:"apiKey" yaml:"apiKey"`         // Google Maps API key (optional)
